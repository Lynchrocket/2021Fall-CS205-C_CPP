...
{
    if(a < 0 || a > 100) throw OutOfRangeException(1,a);
    if(b < 0 || b > 100) throw OutOfRangeException(2,b);
    if(c < 0 || c > 100) throw OutOfRangeException(3,c);
    if(d < 0 || d > 100) throw OutOfRangeException(4,d);
